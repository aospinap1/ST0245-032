...
public class Fecha {
    ...
    public int comparar(Fecha otra) {
        long a = this.anyo*10000 + this.mes*100 + this.dia; 
        long b = otra.anyo*10000 + otra.mes*100 + otra.dia;
        if (a < b) {
            return -1;
        }
        if (a > b) {
    ...
    public String toString() {
        String str = String.valueOf(this.dia) + "-" + String.valueOf(this.mes) + "-" + String.valueOf(this.anyo);
        return str;
    }
